...
export default {
  config: {
    label: 'with Four Items in Three Columns',
    path: '/blocks/content-items/in-three-columns',
  },
  props: {
    anchorName: 'three-col-four-items',
    heading: 'Featured',
    ...
    items: [
      ...
      },
      {
        ...
        body: {
          htmlContent:
            '<p>It <a href="https://www.uber.com/newsroom/history">started</a> as a simple idea: What if you could request a ride from your phone?</p>',
        },
        cta: {
          ctaPrimary: {
            text: 'Sign up to drive',
